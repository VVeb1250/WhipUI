...
export function buildPickBrief({
  ...
  return [
    ...
    selectorLine,
    '',
    'Reference Packet capture contract:',
    ...
    '8. Update .whipui/design-fingerprint.json with durable visual traits, not only copied CSS values. Map the evidence to existing project tokens and components before implementation.',
    '',
    'After capture:',
    'Route the evidence through UI/UX Pro Max for direction when installed, Impeccable for critique when installed, or the existing design-intelligence skill as fallback. Implement the smallest useful adaptation and run visual QA across all axes and viewports.',
    '',
    'Safety boundary:',
